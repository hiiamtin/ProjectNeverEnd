            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse my-nav-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li id="login_bt"><a><?echo $login_logout?></a>
                        </li>
                                ...
                                <div class="row resp-row">
                                    ...
                                    <div class="col-sm-7 col-xs-6 pull-right">
                                        <div class="sd-left-img">
                                            <img src="img/bnr1.png" alt="" class="img-responsive">
                                        </div>
                                    </div>
                        ...
                        <div class="slide-inner slide-2">
                            ...
                            <div class="container">
                                <div class="row resp-row">
                                    ...
                                    <div class="col-sm-7 col-xs-6 pull-right">
                                        <div class="sd-left-img">
                                            <img src="img/bnr2.png" alt="" class="img-responsive">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="slide-inner slide-3">
                            ...
                            <div class="container">
                                <div class="row resp-row">
                                    ...
                                    <div class="col-sm-7 col-xs-6 pull-right">
                                        <div class="sd-left-img">
                                            <img src="img/bnr3.png" alt="" class="img-responsive">
                                        </div>
                                    </div>
                                </div>
                            </div>
